 ...
 * http://blog.csdn.net/hry2015/article/details/78577695?utm_medium=referral
 */
@RestController
public class ComputerFeignFactoryController implements ControllerAware{
	
	@Autowired
	private ComputerFeignService testFeignClient;

	@HystrixCommand(fallbackMethod = "fallback",
			threadPoolKey="thpokey1",
			commandKey="ServiceB-comAdd",
	...
	public String fallback(Integer a, Integer b) {
		return "add异常发生，进入fallback方法，接收的参数：a = {} ,b={}";
	}
	
	public String fallback(Long a, Long b) {
		return "div异常发生，进入fallback方法，接收的参数：a = {} ,b={}";
	}
	...
	public String div(Long a, Long b) {
		return this.testFeignClient.div(a, b).toString();
	}
